    ...
    <div className='w-screen h-screen'>
        ...
        <div className='mx-8'>
            ...
            <div className='flex mb-16'>
                <Link to="/portfolio/huddletailwind" className='flex flex-col w-1/2 py-6 border-t border-r border-b'>
                    <img className='mb-4 h-4 w-2' src={arrowleft} alt='arrowleft' />
                    <h3 className='font-display'>Huddle Tailwind</h3>
                    <p>Previous Project</p>
                </Link>
                <Link to="/portfolio/ecommerce" className='flex flex-col items-end w-1/2 py-6 border-t border-b'>
