...
import screenshot from "../assets/huddlescreenshot.png"
import preview1 from "../assets/huddle-desktop.webp"
import preview2 from "../assets/huddle-mobile.webp"
import arrowleft from "../assets/arrowleft.png"
import arrowright from "../assets/arrowright.png"
import ContactLink from '../components/ContactLink'
import { Link } from 'react-router-dom'

function HuddleTailwindinner() {
  return (
    <div className='w-screen h-full'>
        <div className='mx-8 md:mx-10'>
            <img className='mb-10' src={screenshot} alt='screenshot' />
        </div>
        <div className='mx-8 py-6 border-t border-b mb-12 md:mx-10 md:flex md:items-center md:justify-between'>
            <div className='md:w-1/2'>
                <h1 className='font-display mb-6'>Huddle Tailwind</h1>
                <p className='font-p mb-6'>This project required me to build a fully responsive landingpage to the designs provided. I used HTML5, along with Tailwind and React for the areas that required interactivity.</p>
            </div>
            <div className='md:flex md:flex-col'>
                ...
                <a href='https://tedjenkler.github.io/LandingPage-Tailwindcss/' className='border py-4 px-8'>VISIT WEBSITE</a>
            </div>
        </div>
        <div className='mx-8'>
            ...
            <div className='flex mb-16'>
                <Link to="/portfolio/ecommerce" className='flex flex-col w-1/2 py-6 border-t border-r border-b md:flex-row md:items-center md:gap-6'>
                    <div>
                ...
                <Link to="/portfolio/multipagesite" className='flex flex-col items-end w-1/2 py-6 border-t border-b md:flex-row-reverse md:items-center md:gap-6'>
                    <div>
...
export default HuddleTailwindinner