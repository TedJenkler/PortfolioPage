    ...
    <div className='w-screen h-full'>
        ...
        <div className='mx-8'>
            ...
            <div className='flex mb-16'>
                <Link to="/portfolio/ecommerce" className='flex flex-col w-1/2 py-6 border-t border-r border-b'>
                    <img className='mb-4 h-4 w-2' src={arrowleft} alt='arrowleft' />
                    <h3 className='font-display'>Ecommerce</h3>
                    <p>Previous Project</p>
                </Link>
                <Link to="/portfolio/multipagesite" className='flex flex-col items-end w-1/2 py-6 border-t border-b'>
