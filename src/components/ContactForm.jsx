...
function ContactForm() {
  return (
    <form onSubmit={(e) => {e.preventDefault()}} className='flex flex-col mx-8 mb-20 lg:mx-40'>
        ...
        <input type='email' className='bg-light-grey mb-6 h-12 px-4 invalid:text-error-red invalid:outline-error-red' placeholder='email@example.com'></input>
